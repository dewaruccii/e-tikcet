        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                @can('product')
                    ...
                    <li>
                        <a href="{{ route('admin.products.index') }}"> <i class="menu-icon fa fa-product-hunt"></i>Products
                        </a>
                    </li>
                @endcan
                {{-- <li class="menu-item-has-children dropdown">
                ...
                @can('confirmation')
                    ...
                    <li>
                        <a href="{{ route('admin.pesanan.index') }}"> <i class="menu-icon fa fa-product-hunt"></i>Pesanan
                        </a>
                    </li>
                @endcan
            </ul>
